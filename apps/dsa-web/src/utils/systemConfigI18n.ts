...
const fieldDescriptionMap: Record<string, string> = {
  ...
  DEEPSEEK_THINKING_ENABLED: '控制 DeepSeek thinking 模式。留空或 true 表示开启；false/disabled/0 表示关闭。',
  DEEPSEEK_REASONING_EFFORT: '控制 DeepSeek reasoning_effort，可选 low、high、max。留空则不传该参数。',
