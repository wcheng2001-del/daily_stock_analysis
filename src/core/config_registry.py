...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "DEEPSEEK_API_KEY": {
        ...
        "description": "Official DeepSeek API key (from https://platform.deepseek.com). A key set alone auto-infers deepseek/deepseek-v4-flash and enables thinking mode for supported DeepSeek calls. Also works in multi-channel mode.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "DEEPSEEK_THINKING_ENABLED": {
        "title": "DeepSeek Thinking Enabled",
        "description": "Controls DeepSeek thinking mode for opt-in models such as deepseek-v4-flash. Leave empty or true to enable; set false/disabled/0 to send thinking.type=disabled.",
        "category": "ai_model",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "DEEPSEEK_REASONING_EFFORT": {
        ...
        "description": "Optional DeepSeek reasoning effort override. Supported values: low, high, max. If empty, no reasoning_effort parameter is sent.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
