...
### 5. 风险排查重点
- A 股：减持公告、业绩预亏、监管处罚、行业政策利空、大额解禁、游资/龙虎榜异常
- 美股：财报与 guidance、SEC filings（10-K/10-Q/8-K）、insider trading、analyst rating/target price、short interest、期权隐含波动率、行业监管与反垄断风险
- 非 A 股不得把 A 股专属的政策专项、游资/龙虎榜、解禁/减持专项或主力资金流字段空白视为利空；缺失只说明该市场不适用或未观测，不构成单独降级理由
